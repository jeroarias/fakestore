...
export const Card = ({title, img, text, price}) => {
  return (
      <div className='w-[20%] h-[35rem] m-[1.5rem] mt-[3rem] rounded-[10px] bg-gradient-to-br from-[#7C96AB]  to-white to-[90%] relative '>
        <div className='w-full  absolute '>
            <button className='w-full bg-[#503A7A] text-[#ECE3CE] text-4xl p-[1rem] rounded-t-[10px]'>
                Show More
            </button>
        </div> 
        ...
        <div className='absolute right-[82%] bottom-[0%]  w-[4rem] h-[4rem] bg-[#503A7A]     rounded-bl-[20%] rounded-tr-[100%]  rounded-br-[20%] shadow-md'></div>
        <div className='absolute left-[77%] bottom-[0%] w-full '>
            <button className='w-[5rem] h-[5rem] bg-[#7C96AB] text-6xl font-bold rounded-bl-[50%]  rounded-tl-[50%] rounded-tr-[50%]  rounded-br-[10px] text-[#ECE3CE] shadow-md'>
                +
            </button>
        </div>
    </div>
