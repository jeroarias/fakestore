...
export const Card = ({title, img, text, price,showMore}) => {
  return (
      <div className='w-[22.5%] h-[35rem] m-[1.5rem] mt-[3rem] rounded-[10px] bg-gradient-to-br from-[#7C96AB]  to-white to-[90%] relative '>
        ...
        <div className='absolute right-[85%] bottom-[0%]  w-[4rem] h-[4rem] bg-[#503A7A]     rounded-bl-[20%] rounded-tr-[100%]  rounded-br-[20%] shadow-md'></div>
        <div className='absolute left-[81%] bottom-[0%]  '>
